...
<br> R Projects use relative file paths, which are relative to the working directory of the project.
<br> For example, you want to save a cleaned version of your data, or a plot you have generated.

## Organising Your Work

<br> Here the file paths are relative to the Project directory
<br>
```{r}
#| echo: true
#| output: false
